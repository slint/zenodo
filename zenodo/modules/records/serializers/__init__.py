...
from .schemas.legacyjson import (
    DepositFormSchemaV1,
    FileSchemaV1,
...
deposit_formjson_v1 = LegacyJSONSerializer(DepositFormSchemaV1, replace_refs=True)
#: Zenodo legacy deposit JSON serialzier version 1.0.0
...
oai_datacite = OAIDataCiteSerializer(serializer=datacite_v31, datacentre="CERN.ZENODO")
#: OAI DataCite 4.1 serializer
oai_datacite_v41 = OAIDataCiteSerializer(
    serializer=datacite_v41, datacentre="CERN.ZENODO"
)
...
dcat_response = record_responsify(dcat_v1, "application/rdf+xml")
...
openaire_json_v1_response = record_responsify(
    openaire_json_v1, "application/x-openaire+json"
)
schemaorg_jsonld_v1_response = record_responsify(
...
datacite_v31_search = search_responsify(datacite_v31, "application/x-datacite+xml")
...
#: JSON record serializer for individual records.
deposit_json_v1_response = record_responsify(deposit_json_v1, "application/json")
#: JSON record serializer for search results.
