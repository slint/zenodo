...
def test_update_record_statistics(app, db, es, locations, event_queues, minimal_record):
    ...
    with app.test_client() as client:
        ...
        record_url = url_for("invenio_records_ui.recid", pid_value=recid_v1.pid_value)
