...
from zenodo.modules.records.serializers.schemaorg import ZenodoSchemaOrgSerializer
...
def test_person():
    ...
    data, err = schemaorg.Person().dump(simple_person)
    assert not err
    assert data == {"name": "Doe, John", "affiliation": "CERN", "@type": "Person"}
...
def test_language():
    ...
    assert not err
    assert data == {"alternateName": "pol", "@type": "Language", "name": "Polish"}
...
def test_minimal_software_record(minimal_record_model):
    ...
    data, err = schemaorg.SoftwareSourceCode().dump(dict(metadata=minimal_record_model))
    assert not err
    expected = {
        ...
        u"creator": [{u"@type": u"Person", u"name": u"Test"}],
...
def test_full_record(record_with_files_creation):
    ...
    schema_cls = ZenodoSchemaOrgSerializer._get_schema_class(dict(metadata=record))
    ...
    expected = {
        ...
        u"citation": [
            {u"@id": "https://doi.org/10.1234/foo.bar", u"@type": u"CreativeWork"},
            {
                u"@id": "https://arxiv.org/abs/arXiv:1234.4321",
                u"@type": u"CreativeWork",
            },
            {"@id": "https://arxiv.org/abs/arXiv:1234.4328", "@type": "CreativeWork"},
        ],
        u"contributor": [
            {
            ...
            {u"@type": u"Person", u"affiliation": u"", u"name": u"Hansen, Viggo"},
            {
                u"@type": u"Person",
                u"affiliation": u"CERN",
        ...
        u"creator": [
            ...
            {u"@type": u"Person", u"affiliation": u"CERN", u"name": u"Smith, John"},
            {
        ...
        u"image": u"https://zenodo.org/static/img/logos/zenodo-gradient-round.svg",
        u"inLanguage": {
            u"@type": u"Language",
        ...
        u"isPartOf": [
            {u"@id": "https://doi.org/10.1234/zenodo.4321", u"@type": u"CreativeWork"}
        ],
        u"hasPart": [
            {u"@id": "https://doi.org/10.1234/zenodo.1234", u"@type": u"CreativeWork"}
        ],
