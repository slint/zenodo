...
extras_require = {
    "docs": ["Sphinx>=1.5,<1.6"],
    # Database version
    "postgresql": ["invenio-db[postgresql,versioning]{}".format(db_version)],
    "mysql": ["invenio-db[mysql,versioning]{}".format(db_version)],
    "sqlite": ["invenio-db[versioning]{}".format(db_version)],
    # Elasticsearch version
    "elasticsearch2": ["invenio-search[elasticsearch2]{}".format(search_version)],
    # 'elasticsearch5': [
...
extras_require["xrootd"] = ["invenio-xrootd>=1.0.0a6", "xrootdpyfs>=0.1.5"]

setup_requires = ["Babel>=2.6.0", "pytest-runner>=2.7.0"]
...
setup(
    ...
    platforms="any",
    entry_points={
        "console_scripts": ["zenodo = invenio_app.cli:cli"],
        "flask.commands": [
        ...
        "invenio_base.apps": [
            ...
            "zenodo_communities = " "zenodo.modules.communities.ext:ZenodoCommunities",
            ...
            "zenodo_jsonschemas = " "zenodo.modules.jsonschemas.ext:ZenodoJSONSchemas",
        ...
        "invenio_i18n.translations": ["messages = zenodo"],
        ...
        "invenio_config.module": ["zenodo = zenodo.config"],
        ...
        "invenio_stats.aggregations": [
            "zenodo_stats = " "zenodo.modules.stats.registrations:register_aggregations"
        ],
        "invenio_stats.queries": [
            "zenodo_stats = " "zenodo.modules.stats.registrations:register_queries"
        ],
